...
% Last Modified by GUIDE v2.5 07-Nov-2025 19:35:20
...
function hc_tech_CreateFcn(hObject, eventdata, handles)
    if exist('HC_Tech.jpeg', 'file')
        imshow('HC_Tech.jpeg', 'Parent', hObject);
    else
        text(0.5, 0.5, 'No preview', 'Parent', hObject, ...
